...
{
	public class ClassroomTrainingExport : ExportJob
	{
		public static readonly string Name = nameof(ClassroomTrainingExport);

		public ClassroomTrainingExport(ILog logger, IAwsConfiguration awsConfiguration,
