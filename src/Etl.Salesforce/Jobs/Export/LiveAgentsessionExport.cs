...
{
    public class LiveAgentSessionExport: ExportJob
    {
        public static readonly string Name = nameof(LiveAgentSessionExport);

        public LiveAgentSessionExport(ILog logger, IAwsConfiguration awsConfiguration,
