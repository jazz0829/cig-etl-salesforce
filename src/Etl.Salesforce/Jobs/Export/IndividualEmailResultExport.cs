...
{
    public class IndividualEmailResultExport: ExportJob
    {
        public static readonly string Name = nameof(IndividualEmailResultExport);

        public IndividualEmailResultExport(ILog logger, IAwsConfiguration awsConfiguration,
