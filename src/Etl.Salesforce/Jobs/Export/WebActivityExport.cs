...
{
    public class WebActivityExport : ExportJob
    {
        public static readonly string Name = nameof(WebActivityExport);

        public WebActivityExport(ILog logger, IAwsConfiguration awsConfiguration,
