...
{
    public class RecordTypeExport : ExportJob
    {
        public static readonly string Name = nameof(RecordTypeExport);

        public RecordTypeExport(ILog logger, IAwsConfiguration awsConfiguration,
