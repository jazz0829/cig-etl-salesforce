...
{
	public class CaseHistoryExport : ExportJob
	{
		public static readonly string Name = nameof(CaseHistoryExport);
		private readonly IAmazonKinesis _kinesis;
		protected readonly ISalesForceClient _salesForceClient;

		public CaseHistoryExport(ILog logger, IAwsConfiguration awsConfiguration,
