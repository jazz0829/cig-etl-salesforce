...
{
    public class TopicExport : ExportJob
    {
        public static readonly string Name = nameof(TopicExport);
        private readonly IAmazonKinesis _kinesis;
        protected readonly ISalesForceClient _salesForceClient;

		public TopicExport(ILog logger, IAwsConfiguration awsConfiguration,
