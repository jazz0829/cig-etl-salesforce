...
{
    public class LiveChatVisitorExport: ExportJob
    {
        public static readonly string Name = nameof(LiveChatVisitorExport);

        public LiveChatVisitorExport(ILog logger, IAwsConfiguration awsConfiguration,
