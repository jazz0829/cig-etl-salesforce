...
{
    public class LiveChatButtonSkillExport: ExportJob
    {
        public static readonly string Name = nameof(LiveChatButtonSkillExport);

        public LiveChatButtonSkillExport(ILog logger, IAwsConfiguration awsConfiguration,
