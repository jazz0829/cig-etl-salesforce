...
{
    public class CaseCommentExport : ExportJob
    {
        public static readonly string Name = nameof(CaseCommentExport);

        public CaseCommentExport(ILog logger, IAwsConfiguration awsConfiguration,
