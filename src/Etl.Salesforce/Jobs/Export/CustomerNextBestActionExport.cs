...
{
    public class CustomerNextBestActionExport: ExportJob
    {
        public static readonly string Name = nameof(CustomerNextBestActionExport);

        public CustomerNextBestActionExport(ILog logger, IAwsConfiguration awsConfiguration,
