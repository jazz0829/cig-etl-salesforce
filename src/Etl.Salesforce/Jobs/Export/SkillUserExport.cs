...
{
    public class SkillUserExport: ExportJob
    {
        public static readonly string Name = nameof(SkillUserExport);

        public SkillUserExport(ILog logger, IAwsConfiguration awsConfiguration,
