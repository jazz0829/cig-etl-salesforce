...
{
    public class LiveChatTranscriptEventExport: ExportJob
    {
        public static readonly string Name = nameof(LiveChatTranscriptEventExport);

        public LiveChatTranscriptEventExport(ILog logger, IAwsConfiguration awsConfiguration,
