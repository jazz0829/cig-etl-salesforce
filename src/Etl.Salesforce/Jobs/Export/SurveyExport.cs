...
{
    public class SurveyExport : ExportJob
    {
        public static readonly string Name = nameof(SurveyExport);

        public SurveyExport(ILog logger, IAwsConfiguration awsConfiguration,
