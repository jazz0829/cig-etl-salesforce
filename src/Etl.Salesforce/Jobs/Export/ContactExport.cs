...
{
    public class ContactExport : ExportJob
    {
        public static readonly string Name = nameof(ContactExport);

        public ContactExport(ILog logger, IAwsConfiguration awsConfiguration,
