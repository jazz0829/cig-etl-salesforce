...
{
    public class AccountExport : ExportJob
    {
        public static readonly string Name = nameof(AccountExport);

        public AccountExport(ILog logger, IAwsConfiguration awsConfiguration,
