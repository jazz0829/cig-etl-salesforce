...
{
    public class LiveChatButtonExport: ExportJob
    {
        public static readonly string Name = nameof(LiveChatButtonExport);

        public LiveChatButtonExport(ILog logger, IAwsConfiguration awsConfiguration,
